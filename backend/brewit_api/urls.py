...
urlpatterns = [
    ...
    path('registration-requests/<int:pk>/',
          views.RegistrationRequestDetail.as_view(),
          name='registration-request-detail'),
    path('registration-requests/accept/',
         views.RegistrationRequestAccept.as_view(),
         name='registration-request-accept'),
    path('logout/',
    ...
    path('breweries/me/',
         views.MyBreweryDetail.as_view(),
         name='my-brewery-detail'),
